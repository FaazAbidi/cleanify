...
type UseNormalizationConfigProps = {
  dataset: DatasetType | null;
};

type UseNormalizationConfigReturn = {
...
export function useNormalizationConfig({ dataset }: UseNormalizationConfigProps): UseNormalizationConfigReturn {
