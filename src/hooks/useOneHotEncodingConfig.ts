...
interface UseOneHotEncodingConfigProps {
  dataset: DatasetType | null;
}

interface UseOneHotEncodingConfigReturn {
...
export function useOneHotEncodingConfig({ dataset }: UseOneHotEncodingConfigProps): UseOneHotEncodingConfigReturn {
  ...
  const generatePayload = useCallback(() => {
    ...
    return {
      ...
      method: "perform_one_hot_encoding",
      step: null,
      value: null,
      target: null,
      columns
