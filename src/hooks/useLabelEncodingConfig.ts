...
interface UseLabelEncodingConfigProps {
  dataset: DatasetType | null;
}

interface UseLabelEncodingConfigReturn {
...
export function useLabelEncodingConfig({ dataset }: UseLabelEncodingConfigProps): UseLabelEncodingConfigReturn {
