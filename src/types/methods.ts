...
export type Method = 'fix_missing' | 'perform_binning' | 'perform_combine_features' | 'perform_drop_columns' | 'fix_inconsistencies' | 'perform_label_encoding' | 'perform_normalization' | 'perform_one_hot_encoding' | 'fix_outliers' | 'perform_sampling' | 'fix_skewness' | 'perform_standarization'
